...
function EmployeeList() {
  ...
  return (
    <div className="mt-5">
      {isAdmin != "isAdmin" && (
        <button className="btn btn-primary btn-ver" href="" onClick={goAdmin}>
          Soy admin
        </button>
      )}

      {isAdmin == "isAdmin" && (
        <button className="btn btn-primary btn-del" >
          <a className="cerrar" href="/employees">Cerrar sesión</a>
        </button>
      )}
